@node
@_book=Fragmentum In Librum Primum Regnorum (In Catenis de Cantico Canticorum)
@author=Origenes
...
@urn=urn:cts:greekLit:tlg2042.tlg015.opp-grc1
@valueType=str
@version=1.0
@writtenBy=Text-Fabric
@dateWritten=2019-07-10T11:40:15Z

94	v1 = cod. Vat. gr. 754 saec. X. f. 370 v. v2 = cod. Vat. gr. 398 saec. X? f. 319 r.
