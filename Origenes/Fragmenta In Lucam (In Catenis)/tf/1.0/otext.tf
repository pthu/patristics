...
@sectionFeatures=_book,book,fragment
@sectionTypes=_book,book,fragment
@source1=Perseus Digital Library
@source2=Open Greek and Latin Project
@status=initial unchecked conversion
@structureFeatures=_book,book,fragment,chapter,section
@structureTypes=_book,book,fragment,chapter,section
