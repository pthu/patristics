...
1082	ma/taia GL, om. A, ple/on g. Lightfoot favours the reading of A.
; Lightfoot thinks that fwto/s is an oarly gloss.
Mt. 15, 13
I Cor. 6, 9, 10
I Cor. 10, 16, 17
ei)s qeo/n Gg, (??). L(A).
Job. 3, 8
I Cor. 2, 10
*pra/ssein GL, pra/ssete GA.
Lighfoot emends to *(re/w| on the grounds that this form is justified by inscriptions, shile *(re/w| is unknosn, and g shich has *gai/w| implies this reading.
